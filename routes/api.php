...
Route::post('customer/get-or-create', [CustomerController::class, 'getOrCreateCustomer']);
Route::post('address/get-or-create', [AddressController::class, 'getOrCreateAddress']);
